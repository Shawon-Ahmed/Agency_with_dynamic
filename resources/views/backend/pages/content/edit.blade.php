            ...
            <div class="col-xl-cover">
                <div class="card">
                    ...
                    <div class="card-header p-0 border-0 bg-soft-light">
                        <div class="p-2 mt-4">
                            <form class="needs-validation" type="text" method="POST" action="{{route('content.update', $content->id)}}" enctype="maltipart/form-data" >
                                @csrf
                                <div class="mb-3">
                                    <label for="useremail" class="form-label">Content <span class="text-danger">One</span></label>
                                    <input type="text" class="form-control" id="useremail" value="{{$content->content1}}" autocomple="off" name="content1">
                                </div>
                                <div class="mb-3">
                                    <label for="useremail" class="form-label">Content <span class="text-danger">Two</span></label>
                                    <input type="text" class="form-control" id="useremail" value="{{$content->content2}}" autocomple="off" name="content2">
                                </div>
                                <div class="mb-3">
                                    <label for="useremail" class="form-label">Content <span class="text-danger">Three</span></label>
                                    <input type="text" class="form-control" id="useremail" value="{{$content->content3}}" autocomple="off" name="content3">
                                </div>
                                <div class="mt-4">
